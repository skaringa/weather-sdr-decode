...
# Typical usage: 
# rtl_fm -M -f 433.84M -s 30k | ./decode_mebus.py -
# Help:
# ./decode_mebus.py -h
...
def main():
  ...
  parser.add_argument('inputfile', type=str, nargs=1, help="Input file name. Expects a raw file with signed 16-bit samples in platform default byte order and 30 kHz sample rate. Use '-' to read from stdin. Example: rtl_fm -M -f 433.84M -s 30k | ./decode_mebus.py -")
